      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-8 text-center">
          ...
          <div className="mb-8 flex justify-center">
            <div
              className={`w-32 h-32 rounded-full border-4 border-yellow-400 bg-gradient-to-br from-yellow-300 to-yellow-600 shadow-lg flex items-center justify-center text-2xl font-bold transition-all duration-500 ${isFlipping
                ? 'animate-spin'
                : result
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-200 ${isFlipping || rateLimitTimer !== null
